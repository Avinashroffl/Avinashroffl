...
<img src="https://komarev.com/ghpvc/?username=avinashroffl&label=Profile%20views&color=0e75b6&style=flat" alt="profile views" />
...
![System Design](https://img.shields.io/badge/System%20Design-HLD%20%2F%20LLD-111827?style=for-the-badge)
...
| Role | Org | Period |
|---|---|---|
| Member Technical Staff | Zoho Corporation | Jun 2023 – Present |
| Project Trainee | Zoho Corporation | Jan 2023 – May 2023 |
| Summer Intern | Zoho | Jul 2022 |
...
### Certifications
`Spring Boot (Udemy)` · `SQL 50` · `HackerRank REST API (Java)` · `Google Cloud Facilitator — Highest Milestone` · `Stanford ML` · `IBM Data Science` · `Google Networking` · `Industrial IoT on GCP`
...
⭐️ From [Avinashroffl](https://github.com/Avinashroffl)
